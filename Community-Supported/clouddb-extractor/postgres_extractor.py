...
class PostgresQueryExtractor(BaseExtractor):
    ...
    def new_source_cursor(self, sql_query) -> Any:
        ...
        """
        sqlalchemy_database_uri =  "postgresql+psycopg2://"+self._db_username+":"+self._db_password+"@"+self._db_hostname+":"+self._db_port+"/"+self._db_main_database
    ...
    def hyper_sql_type(self,source_column) -> SqlType:
        ...
        if return_sql_type is None:
            error_message = "No Hyper SqlType defined for Postgres source type: {}".format(
                source_column_type
            )
    ...
    def query_to_hyper_files(
            ...
            - This method is needed here to handle the cursor exeution as well as Postgres dialect
            """
